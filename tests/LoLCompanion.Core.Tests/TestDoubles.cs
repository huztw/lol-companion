...
sealed class WorkflowHandler : HttpMessageHandler
{
    ...
    protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
    {
        ...
        if (path == "/companion/version")
        {
            ...
            {
                Content = new StringContent("""{"schemaVersion":1,"current":{"latestVersion":"1.2.3","downloadUrl":"https://downloads.example.test/lol-companion","sha256":"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"},"analysis":{"currentSchemaVersion":3,"minimumSchemaVersion":3}}""", Encoding.UTF8, "application/json")
            };
        }
